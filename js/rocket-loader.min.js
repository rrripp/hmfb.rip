! function() {
    ...
    function o(t, e) {
        ...
        return !(n && !m[n.trim()] || b && t.hasAttribute("nomodule") || !b && "module" === n)
    }
    ...
    function v(t) {
        ...
        var r = new _(e, {
            ...
            docWriteSimulator: n,
            callback: function() {
                window.__cfRLUnblockHandlers = !0, r.removePreloadHints(),
                    function(t) {
                        var e = new E(t);
                        L.simulateStateBeforeDeferScriptsActivation(), e.harvestDeferScriptsInDocument(), new _(e, {
                            nonce: t,
                            blocking: !1,
                            callback: function() {
        ...
        r.insertPreloadHints(), L.runOnLoad((function() {
            r.run()
        }))
    }
    ...
    instanceof Array && function(t, e) {
        ...
        return n.prototype.enable = function(t) {
            ...
            document.write = S, document.writeln = w, this.buffer.length && (document.contains(this.insertionPointMarker) ? this.insertionPointMarker.parentNode === document.head ? this.insertContentInHead() : this.insertContentInBody() : t("Insertion point marker for document.write was detached from document:", "Markup will not be inserted"))
        }, n.prototype.insertContentInHead = function() {
            var t = new DOMParser,
                n = "<!DOCTYPE html><head>" + this.buffer + "</head>",
                r = t.parseFromString(n, "text/html");
            if (this.scriptStack.harvestScriptsAfterDocWrite(r), e(r.head.childNodes, this.insertionPointMarker), r.body.childNodes.length) {
                for (var o = Array.prototype.slice.call(r.body.childNodes), i = this.insertionPointMarker.nextSibling; i;) o.push(i), i = i.nextSibling;
            ...
            n.innerHTML = this.buffer, this.scriptStack.harvestScriptsAfterDocWrite(n), e(n.childNodes, this.insertionPointMarker)
        }, n.prototype.write = function(t, e) {
            var n, o = document.currentScript;
            o && r(o) && o.hasAttribute("async") ? (n = e ? w : S).call.apply(n, [document].concat(t)) : this.buffer += t.map(String).join(e ? "\n" : "")
        }, n
    }(), I = function() {
        function t() {
            var t = this;
        ...
        return t.prototype.runOnLoad = function(t) {
            ...
            this.bypassEventsInProxies = !0, this.simulatedReadyState = "interactive", u(document, "readystatechange"), this.bypassEventsInProxies = !1
        }, t.prototype.simulateStateAfterDeferScriptsActivation = function() {
            var t = this;
            this.bypassEventsInProxies = !0, u(document, "DOMContentLoaded"), this.simulatedReadyState = "complete", u(document, "readystatechange"), u(window, "load"), this.bypassEventsInProxies = !1, window.setTimeout((function() {
            ...
            try {
                ...
                return void console.warn("encountered an error when accessing " + e + " handler:", t.message)
            }
        }, t
    }(), L = function() {
        var t = window;
        ...
        return e.prototype.insertPreloadHints = function() {
            ...
            this.scriptStack.forEach((function(e) {
                if (o(e, t.settings.nonce)) {
                    var n = r(e),
                        i = /chrome/i.test(navigator.userAgent) && /google/i.test(navigator.vendor) && e.hasAttribute("integrity");
                    if (n && !i) {
                        var a = document.createElement("link");
                        a.setAttribute("rel", "preload"), a.setAttribute("as", "script"), a.setAttribute("href", n), e.crossOrigin && a.setAttribute("crossorigin", e.crossOrigin), document.head.appendChild(a), t.preloadHints.push(a)
                    }
                }
            }))
            ...
            for (var t = this, e = this; this.scriptStack.hasItems;) {
                var n = function() {
                    ...
                    return o ? r.external && r.executable && !r.async ? (c(o, (function() {
            ...
            this.settings.docWriteSimulator && !t.async && this.settings.docWriteSimulator.flushWrittenContentAndDisable(), L.updateInlineHandlers(), n(t.placeholder)
            ...
            var n = e.script,
                ...
                i = e.async,
                a = r.parentNode;
            if (!document.contains(r)) return t("Placeholder for script \n" + n.outerHTML + "\n was detached from document.", "Script will not be executed."), null;
            var c = this.settings.blocking && o && !i ? p(n) : s(n);
            return c ? (a.insertBefore(c, r), c) : (t("Failed to create activatable copy of script \n" + n.outerHTML + "\n", "Script will not be executed."), null)
        }, e
    }(), H = "data-cf-settings", D = "|", N = "data-cf-modified-", O = void 0;
    ! function() {
        ...
        if (e) {
            ...
            }(r), L.updateInlineHandlers(), r.bailout ? function(t) {
                var e = new A(t),
                    n = new k(e);
                e.harvestScriptsInDocument(), new _(e, {
                    nonce: t,
                    blocking: !0,
                    docWriteSimulator: n,
                    callback: function() {}
            ...
            }(), v(r.nonce))) : t("Activator script doesn't have settings. No scripts will be executed.")
